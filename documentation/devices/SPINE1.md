...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.10.10.101/24 | 10.10.10.1 |
...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.100.1 | Port-Channel7 |
...
| Ethernet7 | MLAG_SPINE2_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_SPINE2_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
!
interface Ethernet7
   description MLAG_SPINE2_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_SPINE2_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| Port-Channel7 | MLAG_SPINE2_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel7
   description MLAG_SPINE2_Port-Channel7
   no shutdown
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4094 |  default  |  192.168.100.0/31  |  -  |  -  |  -  |  -  |
