...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.10.10.102/24 | 10.10.10.1 |
...
```eos
ip name-server vrf MGMT 10.10.10.1
```
...
| -------------- | ------------------- | --- | -------------- | -------------- | -------------- | ---------- |
| gzip | 10.1.1.10:9910 | MGMT | token,/tmp/token | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | False |
...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=10.1.1.10:9910 -cvauth=token,/tmp/token -cvvrf=MGMT -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -ingestexclude=/Sysdb/cell/1/agent,/Sysdb/cell/2/agent -taillogs
   no shutdown
```
...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.100.0 | Port-Channel7 |
...
| Ethernet7 | MLAG_SPINE1_Ethernet7 | *trunk | *- | *- | *MLAG | 7 |
| Ethernet8 | MLAG_SPINE1_Ethernet8 | *trunk | *- | *- | *MLAG | 7 |
...
!
interface Ethernet7
   description MLAG_SPINE1_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_SPINE1_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| Port-Channel7 | MLAG_SPINE1_Port-Channel7 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel7
   description MLAG_SPINE1_Port-Channel7
   no shutdown
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4094 |  default  |  192.168.100.1/31  |  -  |  -  |  -  |  -  |
